...
<div id="content">
  <form action="" id="form-submit">
    <div id="search">
      <p class="info-list" id="info-name">
        预约人：<input type="text" name="userName" placeholder="请输入用户的姓名" value="">
      </p>
      <p class="info-list">
        手机号：<input type="text" name="phone" placeholder="请输入用户的手机号" value="">
      <p class="info-list" id="info-date">日期选择：<input type="text" class="input" id="pickdate" placeholder="请选择日期"/></p>
      <p class="info-list">
    ...
    <div id="info-badmin">
      <div class="badminton active">
        <p><input type="radio" name="badminton" value="" />01号场地</p>
      </div>
      <div class="badminton">
        <p><input type="radio" name="badminton" value="" /> 02号场地</p>
      </div>
      <div class="badminton">
        <p><input type="radio" name="badminton" value="" />03号场地</p>
      </div>
      <div class="badminton active">
        <p><input type="radio" name="badminton" value="" />04号场地</p>
      </div>
      <div class="badminton">
        <p><input type="radio" name="badminton" value="" />05号场地</p>
      </div>
      <div class="badminton">
        <p><input type="radio" name="badminton" value="" />06号场地</p>
      </div>
    </div>
...
<script src="<%=basePath%>common/js/checkItem.js"></script>
...
<script src="<%=basePath%>common/js/timedropper.min.js"></script>
<script src="<%=basePath%>common/js/addItem.js"></script>
<script src="../common/js/checkItem.js"></script>
-->
